# DRAFT PM Task Specification — Task2022: Admin Dispatch Public Safe-deny Smoke / Approved Target Only
...
- Suggested commit message: `Task2022 admin dispatch public safe-deny smoke`
