# DRAFT PM Task Specification — Task2027: Zeabur DB Target Classification / No Secret Values
...
- Suggested commit message: `Task2027 zeabur db target classification`
