...
Phase: Phase 8 — Customer-facing Completion Report Publication

Purpose:
- Run minimal approved customer-facing route smoke only after target approval; no fixture/destructive smoke.
...
- Run only the explicitly approved minimal smoke against the approved target.
...
- Do not run destructive fixture smoke or smoke against unapproved/shared/prod targets.
