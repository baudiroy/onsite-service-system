...
## Task1990 — Engineer Mobile Offline and Retry Boundary

Phase: Phase 18 — Admin Frontend, Engineer Mobile UX, and PWA Hardening

Purpose:
- Plan/implement bounded retry/offline behavior without duplicate unsafe actions.
