...
## Task1906 — Admin Dispatch DB-backed Smoke / Approved Target Only

Phase: Phase 10 — Admin Dispatch and Operations Runtime

Purpose:
- Run minimal DB-backed admin dispatch smoke only after explicit target approval.
...
- DB/migration execution requires explicit approved target and separate approval phrase.
