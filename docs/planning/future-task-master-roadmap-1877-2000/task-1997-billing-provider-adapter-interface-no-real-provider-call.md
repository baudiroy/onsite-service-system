...
## Task1997 — Billing Provider Adapter Interface / No Real Provider Call

Phase: Phase 19 — Billing Provider, Settlement, and Invoicing Gate

Purpose:
- Implement provider adapter interface with fake provider tests only.
