...
## Task1956 — Customer AI FAQ Suggestion / No Mutation

Phase: Phase 15 — Customer AI, Customer Portal, and LINE-safe Channel Integration

Purpose:
- Implement customer AI FAQ suggestions without modifying Case/Report data.

Allowed work:
- Perform the bounded work described by this task only after PM assigns it.
