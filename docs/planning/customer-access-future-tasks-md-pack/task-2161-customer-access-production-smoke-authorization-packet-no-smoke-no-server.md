...
Create authorization packet for future production/staging smoke without running smoke or starting server.
...
- `git diff --check -- docs/task-2161-customer-access-production-smoke-authorization-packet-no-smoke-no-server.md`
- `git status --short --branch`

## Required tests / acceptance behavior

Define explicit authorization phrase, target environment, allowed endpoints, no secrets, stop conditions, completion report. Generic phrases insufficient.
