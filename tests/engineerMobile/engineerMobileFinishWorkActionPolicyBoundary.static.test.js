...
const POLICY_FILE = 'src/engineerMobile/engineerMobileFinishWorkActionPolicy.js';
const UNIT_TEST_FILE = 'tests/engineerMobile/engineerMobileFinishWorkActionPolicy.unit.test.js';
const BOUNDARY_TEST_FILE = 'tests/engineerMobile/engineerMobileFinishWorkActionPolicyBoundary.static.test.js';
const TASK_DOC = 'docs/task-1800-engineer-mobile-finish-work-action-policy-no-db-no-global-mount.md';
...
test('Task1800 allowed files exist', () => {
...
test('finish-work action policy imports nothing and stays isolated from forbidden runtimes', () => {
...
test('finish-work action policy does not execute persistence provider route or completion workflow calls', () => {
  const source = read(POLICY_FILE);
...
test('Task1800 doc records required no-runtime-expansion boundaries', () => {
