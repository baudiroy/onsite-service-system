...
function readyEnvelope(draft) {
  ...
  return sanitizeNestedValue({
    ...
    brandId: safeString(fields.brandId) || undefined,
    serviceProviderId: safeString(fields.serviceProviderId) || undefined,
    duplicateStatus: safeString(fields.duplicateStatus) || undefined,
    duplicateCandidate: isPlainObject(fields.duplicateCandidate) ? fields.duplicateCandidate : undefined,
    reporterRef: fields.reporterRef,
    customerRef: fields.customerRef,
    billingContactRef: fields.billingContactRef,
    onSiteContactOverrideRef: fields.onSiteContactOverrideRef,
    contactRoleSeparation: safeString(fields.contactRoleSeparation) || undefined,
    platformAccepted: fields.platformAccepted === true ? true : undefined,
    importAccepted: fields.importAccepted === true ? true : undefined,
