...
const ENGINEER_MOBILE_AUDIT_WRITER_RESULT_KEYS = Object.freeze([
  'ok',
  'status',
  'auditWritten',
  'persisted',
...
const ENGINEER_MOBILE_AUDIT_WRITER_STATUSES = Object.freeze([
  'recorded',
  'skipped',
  'failed',
]);

const ENGINEER_MOBILE_AUDIT_WRITER_REASON_CODES = Object.freeze([
...
const VALID_REASON_CODES = new Set(ENGINEER_MOBILE_AUDIT_WRITER_REASON_CODES);
...
const FALLBACK_FAILED_REASON_CODE = 'invalid_writer_result';
const FALLBACK_SKIPPED_REASON_CODE = 'audit_skipped';
...
function failed(reasonCode = FALLBACK_FAILED_REASON_CODE) {
  return {
    ok: false,
    status: STATUS_FAILED,
    auditWritten: false,
    persisted: false,
    reasonCode: safeReasonCode(reasonCode, FAILED_REASON_CODES) || FALLBACK_FAILED_REASON_CODE,
  };
}
...
function skipped(reasonCode) {
  return {
    ...
    auditWritten: false,
    persisted: false,
    reasonCode: safeReasonCode(reasonCode, SKIPPED_REASON_CODES) || FALLBACK_SKIPPED_REASON_CODE,
  };
}

function normalizeEngineerMobileAuditWriterResult(input) {
